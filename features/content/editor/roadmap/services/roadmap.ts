...
export const roadmapService = {
  ...
  createRoadmap: (data: { title: string; description?: string; ownerType?: string; ownerId?: string }) => 
  ...
  updateRoadmap: (id: string, data: { title?: string; description?: string; graphJson?: string; version?: number }) => 
