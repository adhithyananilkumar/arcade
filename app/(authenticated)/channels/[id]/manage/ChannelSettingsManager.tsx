...
import { Upload, Image as ImageIcon, Loader2, Shield, AlertTriangle, Trash2, Lock, Tv, FileText } from 'lucide-react';
          ...
          <div className="space-y-2">
            ...
            <div className="overflow-hidden rounded-3xl border border-slate-200/80 bg-gradient-to-br from-slate-50/90 via-blue-50/40 to-slate-50/90 p-3.5 sm:p-5 shadow-2xs">
              ...
              <div className="group relative rounded-2xl overflow-hidden shadow-xs">
                ...
                {canManageSettings && bannerPreview && (
                  <button
                    type="button"
                    onClick={handleRemoveBannerClick}
                    className="absolute top-3 right-3 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-white/95 text-red-500 opacity-0 transition-opacity group-hover:opacity-100 shadow-md hover:bg-red-50 hover:text-red-600 backdrop-blur-xs"
                    title="Remove Banner"
                  >
                    <Trash2 size={15} />
                  </button>
                  ...
                  <div className="flex flex-wrap items-center gap-2 pb-1">
                    ...
                    {bannerPreview && (
                      <button
                        type="button"
                        onClick={handleRemoveBannerClick}
                        className="inline-flex items-center gap-1.5 rounded-xl border border-red-200/80 bg-red-50/70 px-3.5 py-1.5 text-[11px] font-extrabold text-red-700 hover:bg-red-100/80 transition-all shadow-2xs"
                      >
