...
import { Upload, Image as ImageIcon, Loader2, AlertTriangle, Info, X } from 'lucide-react';
...
export function ChannelSettingsManager({ channel, onUpdate }: Props) {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className="space-y-8 max-w-3xl">
      <div>
        <h3 className="text-lg font-bold text-gray-900 mb-1">Channel Branding</h3>
        <p className="text-sm text-gray-500 mb-6">Customize how your channel looks to learners.</p>
        ...
        <div className="space-y-6">
            ...
            <div className="relative overflow-hidden rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50 hover:bg-gray-100 transition-colors group">
              {bannerPreview ? (
                ...
                <div className="aspect-[4/1] w-full flex flex-col items-center justify-center text-gray-500">
                  ...
                  <span className="text-xs text-gray-400 mt-1">Recommended: 1200x300px</span>
                </div>
              )}
              <input 
                type="file" 
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-6">
              <div className="relative h-24 w-24 rounded-full border-4 border-white shadow-md bg-gray-100 overflow-hidden group">
                {iconPreview ? (
                  <img src={iconPreview} alt="Logo Preview" className="h-full w-full object-cover" />
                ) : (
              ...
              <div className="text-sm text-gray-500">
                ...
                <p>Square image recommended (e.g. 250x250px)</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-gray-100 pt-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Channel name changes are not permitted.</p>
          </div>
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end pt-4">
        <button
          type="submit"
          disabled={loading}
          className="flex items-center gap-2 rounded-xl bg-indigo-600 px-6 py-2.5 text-sm font-bold text-white shadow-sm transition-all hover:bg-indigo-700 disabled:opacity-70 disabled:cursor-not-allowed"
        >
