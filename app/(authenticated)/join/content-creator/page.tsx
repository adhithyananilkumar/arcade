...
import { CreatorService } from '@/services/studio/publishing/creator.service';
...
export default function JoinCreatorPage() {
  ...
  const acceptInvite = async () => {
    try {
      await CreatorService.acceptInvitation(token as string);
      setStatus('success');
      ...
      >
        {status === 'loading' && (
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold text-gray-900">Accepting Creator Invite...</h2>
            <p className="text-sm text-gray-500 mt-2">Please wait while we process your invitation.</p>
          </div>
        )}
        ...
        {status === 'success' && (
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-gray-500 mt-2">You are now a Content Creator! Redirecting to your dashboard...</p>
          </div>
        )}
