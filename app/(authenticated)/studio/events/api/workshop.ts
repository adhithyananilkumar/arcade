...
import { CreateWorkshopRequest, Workshop, WorkshopFormData, CreateWorkshopSessionRequest, UpdateWorkshopSessionRequest, WorkshopSession } from '@/app/(authenticated)/studio/events/types';
