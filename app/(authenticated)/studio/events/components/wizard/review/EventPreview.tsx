...
export function EventPreview({ data, onRegister, showActions = true }: { data: WorkshopPreviewDto, onRegister?: () => void, showActions?: boolean }) {
  ...
  const renderActionButton = () => {
    const initialState = registration ? (
      registration.registrationStatus === 'APPROVED' || registration.registrationStatus === 'COMPLETED' ? 'ENROLLED' :
      registration.registrationStatus === 'WAITLISTED' ? 'NOT_ENROLLED' : 'NOT_ENROLLED'
    ) : 'NOT_ENROLLED';
