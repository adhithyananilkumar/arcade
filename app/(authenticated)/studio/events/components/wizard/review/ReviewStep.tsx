...
import { validateWorkshop, submitWorkshop, archiveWorkshop, duplicateWorkshop, getWorkshopPreview } from '@/app/(authenticated)/studio/events/api/publish';
import { CourseSubmitDialog } from '@/apps/creator/components/CourseSubmitDialog';
import { PublishValidationResponse, WorkshopPreviewDto } from '@/app/(authenticated)/studio/events/types';
