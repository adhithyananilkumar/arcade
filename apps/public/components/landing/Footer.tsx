  ...
  return (
    <footer className="arc-footer">
      <div className="arc-footer__container">
        {/* SECTION 1: Integrated Pre-Footer CTA Section */}
        <div className="arc-footer__cta-section">
          <div className="arc-footer__cta-content">
            <h2 className="arc-footer__cta-heading">Your next skill is waiting.</h2>
            <p className="arc-footer__cta-subtext">
              Explore courses. Connect with mentors. Discover where you want to go.
            </p>
          </div>
          <div className="arc-footer__cta-actions">
            <Link href="/explore" className="arc-footer__btn-primary">
              <span>Explore Catalog</span>
              <span className="arc-footer__btn-arrow">→</span>
            </Link>
            <Link href="/signup" className="arc-footer__btn-secondary">
              <span>Join Arcade</span>
            </Link>
          </div>
        </div>

        {/* SECTION 2: Explore by Interest Pills */}
        <div className="arc-footer__interests-bar">
          <span className="arc-footer__interests-label">POPULAR INTERESTS:</span>
          <div className="arc-footer__interests-tags">
            <Link href="/courses?category=Artificial+Intelligence" className="arc-footer__tag">AI & ML</Link>
            <Link href="/courses?category=Computer+Science" className="arc-footer__tag">Web Development</Link>
            <Link href="/courses?category=Design" className="arc-footer__tag">UI/UX Design</Link>
            <Link href="/courses?category=Cyber+Security" className="arc-footer__tag">Cyber Security</Link>
            <Link href="/courses?category=Data+Science" className="arc-footer__tag">Data Science</Link>
            <Link href="/courses?category=Cloud" className="arc-footer__tag">Cloud Computing</Link>
          </div>
        </div>

        {/* SECTION 3: Main 4-Column Layout */}
        <div className="arc-footer__grid">
          {/* COLUMN 1: Brand & Connect */}
          <div className="arc-footer__brand-col">
            <div className="arc-footer__logo-wrapper">
              <svg
                width="120"
                height="26"
                viewBox="0 0 347 77"
                ...
                className="arc-footer__logo"
              >
                <defs>
                  <linearGradient id="arcade-footer-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <div className="arc-footer__connect">
              ...
              <div className="arc-footer__socials">
                ...
                {/* Instagram */}
                <a href="https://instagram.com" target="_blank" rel="noreferrer" className="arc-footer__social-btn" aria-label="Instagram">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* YouTube */}
                <a href="https://youtube.com" target="_blank" rel="noreferrer" className="arc-footer__social-btn" aria-label="YouTube">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* Facebook */}
                <a href="https://facebook.com" target="_blank" rel="noreferrer" className="arc-footer__social-btn" aria-label="Facebook">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="arc-footer__col">
            <h4 className="arc-footer__col-title">EXPLORE</h4>
            <ul className="arc-footer__list">
              <li><Link href="/explore">Explore Catalog</Link></li>
              <li><Link href="/courses?category=Computer+Science">Departments</Link></li>
              <li><Link href="/placement">Career Labs</Link></li>
              <li><Link href="/forum">Interest Groups</Link></li>
              <li><Link href="/content-creator">Contact Us</Link></li>
              <li><Link href="/library">Donate</Link></li>
            </ul>
          </div>

          {/* COLUMN 3: COMMUNITY */}
          <div className="arc-footer__col">
            <h4 className="arc-footer__col-title">COMMUNITY</h4>
            <ul className="arc-footer__list">
              <li><a href="https://www.amaljyothi.ac.in" target="_blank" rel="noreferrer">Campus</a></li>
              <li><Link href="/placement">Companies</Link></li>
              <li><Link href="/explore">Students</Link></li>
              <li><Link href="/forum">Mentors</Link></li>
            </ul>
          </div>

          {/* COLUMN 4: ABOUT / LEGAL */}
          <div className="arc-footer__col">
            <h4 className="arc-footer__col-title">ABOUT / LEGAL</h4>
            <ul className="arc-footer__list">
              <li><Link href="/terms">Terms and Conditions</Link></li>
              <li><Link href="/privacy">Privacy Policy</Link></li>
              <li><Link href="/privacy">Refund Policy</Link></li>
              <li><Link href="/privacy">Cookie Settings</Link></li>
            </ul>
          </div>
        </div>

        {/* SECTION 4: Arcade Brand Visual Signature Line */}
        <div className="arc-footer__signature-line">
          <div className="arc-footer__journey">
            <span className="arc-footer__journey-step">Learn</span>
            <span className="arc-footer__journey-arrow">→</span>
            <span className="arc-footer__journey-step">Connect</span>
            <span className="arc-footer__journey-arrow">→</span>
            <span className="arc-footer__journey-step">Create</span>
            <span className="arc-footer__journey-arrow">→</span>
            <span className="arc-footer__journey-step">Grow</span>
          </div>
        </div>

        {/* SECTION 5: Refined Copyright / Contact Bar */}
        <div className="arc-footer__bottom">
          <div className="arc-footer__bottom-left">
            <p className="arc-footer__copyright">
              <strong>Arcade Catalog</strong> | Copyright © 2026 All rights reserved.
            </p>
            <p className="arc-footer__address">
              Amal Jyothi College of Engineering, Kanjirappally, Kerala - 686518
            </p>
          </div>

          <div className="arc-footer__bottom-right">
            <a href="mailto:info@amaljyothi.ac.in" className="arc-footer__contact-link">
            ...
            <a href="https://www.amaljyothi.ac.in" target="_blank" rel="noreferrer" className="arc-footer__contact-link">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <circle cx="12" cy="12" r="10"/>
                <path d="M2 12h20M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 014-10z"/>
              </svg>
              <span>www.amaljyothi.ac.in</span>
            </a>

            <button onClick={scrollToTop} className="arc-footer__back-to-top" aria-label="Back to top">
              <span>Back to top</span>
              <span className="arc-footer__arrow-up">↑</span>
            </button>
          </div>
        </div>
      </div>

      {/* SECTION 6: Major Visual Signature - Large Campus Architectural Building Illustration */}
      <div className="arc-footer__campus-sketch">
        <div className="arc-footer__sketch-fade-top"></div>
        <img
          src="/college-sketch.svg"
          alt="Amal Jyothi College of Engineering Campus Architectural Sketch"
