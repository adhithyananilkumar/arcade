...
export default function Radar({
  ...
  useEffect(() => {
    ...
    // Absolute position style on WebGL canvas to ensure it fits the container bounds
    gl.canvas.style.position = "absolute";
    gl.canvas.style.top = "0";
    gl.canvas.style.left = "0";
    gl.canvas.style.width = "100%";
    gl.canvas.style.height = "100%";
    gl.canvas.style.pointerEvents = "none"; // Let mouse hover pass through canvas to cards
    ...
    if (enableMouseInteraction) {
      gl.canvas.style.pointerEvents = "auto"; // Re-enable pointer events if interactive
