...
export function MyChannels() {
  ...
  // Channel creation is invite-gated (see ChannelCreationInvitationService on the backend) — a
  // platform admin invites a specific person by email/username, who then completes the request
  // via the mailed /channel-invite link. There is no self-serve "Create Channel" button here.
  const createHint = (
    <p className="text-[12px] font-medium text-slate-400">
      Channel creation is invite-only — ask a platform admin to invite you.
    </p>
  );
