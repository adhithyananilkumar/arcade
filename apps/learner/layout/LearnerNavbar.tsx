      ...
      <div className="flex items-center gap-3">
        ...
        <div className="pointer-events-auto flex items-center h-12 bg-transparent px-1 relative z-50">
          <MenuContainer>
            ...
            <div className="flex h-full w-full items-center justify-between pl-1 pr-1 gap-2 cursor-pointer">
              ...
              <div className="h-8 w-8 shrink-0 rounded-full overflow-hidden border border-black/5 dark:border-white/10 shadow-xs">
                {user?.avatarUrl ? (
                  ...
                  <div className="flex h-full w-full items-center justify-center bg-sky-100 dark:bg-sky-900/50 text-sky-700 dark:text-sky-300 text-xs font-bold">
