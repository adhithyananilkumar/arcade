...
export default function CollegesPageClient() {
  ...
  return (
    <div className="landing-root min-h-screen flex flex-col font-sans antialiased overflow-x-hidden">
      {/* Top Navbar Navigation */}
      <HeroNav />

      {/* Main Container */}
      <main className="flex-grow pt-28 lg:pt-36 bg-transparent relative">
