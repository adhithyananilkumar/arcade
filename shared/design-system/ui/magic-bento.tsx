...
const DEFAULT_GLOW_COLOR = '41, 98, 214'; // Arcade Blue Palette
...
export const MagicBento = ({
  ...
  return (
    <>
      ...
      <div className="card-grid bento-section grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-4" ref={gridRef}>
        {children}
      </div>
    </>
  );
